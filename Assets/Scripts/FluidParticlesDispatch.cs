...
public class FluidParticlesDispatch : MonoBehaviour
{
    ...
    void Start()
    {
        affectorPrev = oscReceiver.mainsource;
        ...
        fluidSourcesKernel = fluidSourcesComputeShader.FindKernel("AddSources");
    ...
    void AddVelocitySources(Vector3 difference)
    {
        ...
        fluidSourcesComputeShader.SetFloat("size", affectorSize);
        fluidSourcesComputeShader.SetVector("sourcePosition", oscReceiver.mainsource);
        fluidSourcesComputeShader.SetVector("sourceVelocity", difference * affectorVelocityScale);
        fluidSourcesComputeShader.SetVector("constantForces", constantForces);
    ...
    private void Update()
    {
        ...
        AddVelocitySources(affectorPrev - oscReceiver.mainsource);
